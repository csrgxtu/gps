...
class GoogleSearch(object):
    ...
    """
    SEARCH_URL_0 = "http://64.15.124.55/search?hl=%(lang)s&q=%(query)s&btnG=Google+Search"
    NEXT_PAGE_0 = "http://64.15.124.55/search?hl=%(lang)s&q=%(query)s&start=%(start)d"
    SEARCH_URL_1 = "http://64.15.124.55/search?hl=%(lang)s&q=%(query)s&num=%(num)d&btnG=Google+Search"
    NEXT_PAGE_1 = "http://64.15.124.55/search?hl=%(lang)s&q=%(query)s&num=%(num)d&start=%(start)d"
