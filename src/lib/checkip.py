...
g_cacertfile = os.path.join(g_filedir, config.CACERT_FILE)
g_ipfile = os.path.join(g_filedir, config.IP_FILE)
g_tmpokfile = os.path.join(g_filedir, config.IP_TMP_OK_FILE)
g_tmperrorfile = os.path.join(g_filedir, config.IP_TMP_ERR_FILE)
g_exttraipfile = os.path.join(g_filedir, config.EXTRA_IP_FILE)
