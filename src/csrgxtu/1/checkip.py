...
g_cacertfile = os.path.join(g_filedir, "./static/cacert.pem")
g_ipfile = os.path.join(g_filedir, "./static/ip.txt")
g_tmpokfile = os.path.join(g_filedir, "./static/ip_tmpok.txt")
g_tmperrorfile = os.path.join(g_filedir, "./static/ip_tmperror.txt")
g_exttraipfile = os.path.join(g_filedir,"./static/extraip.txt")
